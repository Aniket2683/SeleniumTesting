...
class handle_calendar3():
    def demo_calendar3(self):
        ...
        driver.find_element(By.XPATH,"//td[@data-handler='selectDay']/a[text()='26']").click()
        time.sleep(5)
        driver.quit()

demo1 = handle_calendar3()
demo1.demo_calendar3()